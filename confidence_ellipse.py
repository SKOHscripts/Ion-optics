...
ax_nstd.hexbin(x, y, gridsize=500, cmap='inferno')
...
ax_nstd.set_title('Defocusin and focusing electrostatic quadrupole doublet approximation')

ax_nstd.set_xlim((-7.5, 7.5))
ax_nstd.set_ylim((-3, 3))
